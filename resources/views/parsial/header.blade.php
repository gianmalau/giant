    ...
    <div class="uk-navbar-container tm-navbar-container" uk-sticky="cls-active: tm-navbar-container-fixed">
        <div class="uk-container" uk-navbar>
            <div class="uk-navbar-left"><button class="uk-navbar-toggle uk-hidden@m"
                    ...
                    class="uk-navbar-item uk-logo" href="/"><img src="images/logo.svg" width="90"
                                    ...
                                    <ul class="uk-navbar-dropdown-grid uk-child-width-1-5" uk-grid>
                                        <li>
                                            <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                    ...
                                                    <div class="uk-text-bolder" align="center">Laptop</div>
                                                </a>
                                        ...
                                        <li>
                                            <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                    ...
                                                    <div class="uk-text-bolder" align="center">Komputer Rakitan</div>
                                                </a>
                                                {{-- <ul class="uk-nav uk-nav-default">
                                        ...
                                        <li>
                                            <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                    href="category.html"><img
                                                        ...
                                                        width="80" height="80">
                                                    <div class="uk-text-bolder" align="center">Spare Part</div>
                                                </a>
                                                {{-- <ul class="uk-nav uk-nav-default">
                                        ...
                                        <li>
                                            <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                    ...
                                                    <div class="uk-text-bolder" align="center">Hardware</div>
                                                </a>
                                                {{-- <ul class="uk-nav uk-nav-default">
                                        ...
                                        <li>
                                            <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                    href="category.html"><img
                                                        ...
                                                        height="80">
                                                    <div class="uk-text-bolder" align="center">Accessories</div>
                                                </a>
                                                {{-- <ul class="uk-nav uk-nav-default">
